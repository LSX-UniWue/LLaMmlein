# We include a simple full-parameter finetuning & inference script here. Our V0.1 finetune model is finetuned using this script.
...
# We hope the community can explore on finetuning TinyLlama and come up with better finetune models. I will include community-finetuned models in this repo.
