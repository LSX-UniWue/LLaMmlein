...
def copy_weights_llama(
    ...
    weight_map = {
        ...
        # TODO https://github.com/Lightning-AI/litgpt/blob/main/litgpt/scripts/convert_lit_checkpoint.py#L129
      #  "transformer.h.{}.mlp.swiglu.c_fc.weight": "model.layers.{}.mlp.gate_proj.weight",
      #  "transformer.h.{}.mlp.swiglu.c_proj.weight": "model.layers.{}.mlp.up_proj.weight",
      #  "transformer.h.{}.mlp.swiglu.out_proj.weight": "model.layers.{}.mlp.down_proj.weight",
...
def convert_config_lit_to_hf(lit_config_dict: dict) -> dict:
    ...
    hf_config_dict["vocab_size"] = 32064

    return hf_config_dict


@torch.inference_mode()
def convert_lit_checkpoint(*, checkpoint_name: str, out_dir: Path, model_name: str, model_only: bool = True) -> None:
    config = Config.from_name(model_name)

    if "falcon" in model_name:
        copy_fn = partial(copy_weights_falcon, "40b" if config.n_embd == 8192 else "7b")
    elif config._mlp_class == "LLaMAMLP" or config._mlp_class == "xformersfree_LLaMAMLP":
...
if __name__ == "__main__":
    ...
    ckpt = torch.load("/hnvme/workspace/b185cb13-llammlein/out/tiny_LLaMA_32B_fa3_testing/iter-00000100-ckpt-consolidated.pth", map_location="cpu")
    print(ckpt.keys())
